...
fit_RescorlaWagner_feedb<-function(data,alphaBound, betaBound, initialQ){
  ...
  obfunc<-function(x) lik_RescorlaWagner_feedb(data, x[1], x[2],1, initialQ) # this function is similar to the MATLAB "handle" function
